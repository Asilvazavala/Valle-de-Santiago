...
export default function NavbarMobile() {
  ...
  return (
    <header className="lg:hidden bg-gradient-to-r from-primary to-secondary py-3 md:px-6 fixed 
    top-0 z-[9998] w-full">
          ...
          {linksNavbar.map((item, index) => (
            <div key={index}>
              {item.href !== ''
                ...
                : <li className="flex flex-col justify-between w-full text-2xl py-2 border-white border-b 
                  px-8 text-white">
                    <article 
